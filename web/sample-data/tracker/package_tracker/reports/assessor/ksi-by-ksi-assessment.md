...
- **Missing evidence:** A **registry or catalog gap** — a criterion `evidence_required` id is absent from `evidence_source_registry`, so the engine cannot score that path. This is **not** the same as “manual evidence,” where sources are registered and assessor attestation is expected.
- **Manual evidence:** Registered sources plus catalog/criterion `validation_type` manual/hybrid and/or file- or narrative-primary collection; evidence is expected out-of-band by design.
...
- **Evidence posture (machine):** `missing_required_evidence=False`; `relies_on_manual_or_file_primary_evidence=False`; `automation_maturity_score=3`
...
- **`FIND-SI4-ALERT-INSTRUMENTATION-7712019CD417`** — severity `high` — POA&M: `POAM-AUTO-SI4-ALERT-INSTRUMENTATION-001`, `POAM-F20X-D-SI4-ALERT-INSTRUMENTATION-7712019CD417`
  ...
  - Assessor workpaper: current `No alert rules are defined while security-relevant semantic events require instrumentation.` → target `Evidence for SI-4, SI-4(1), SI-4(4), SI-4(16) is complete, system-generated where possible, linked to the affected asset/event/finding population, and retestable by an assessor sample.`; priority `critical`, effort `1-3 days`.
  - Remediation sample: Generate SPL/KQL/GCP/AWS query.; Add enabled alert.; Add recipient list.
- **`FIND-SI4-ALERT-INSTRUMENTATION-3B5CDDC852D6`** — severity `high` — POA&M: `POAM-AUTO-SI4-ALERT-INSTRUMENTATION-001`, `POAM-F20X-D-SI4-ALERT-INSTRUMENTATION-3B5CDDC852D6`
  ...
  - Assessor workpaper: current `No enabled alert rule covers logging.audit_disabled.` → target `Evidence for SI-4, SI-4(1), SI-4(4), SI-4(16) is complete, system-generated where possible, linked to the affected asset/event/finding population, and retestable by an assessor sample.`; priority `critical`, effort `1-3 days`.
  - Remediation sample: Generate SPL/KQL/GCP/AWS query.; Add enabled alert.; Add recipient list.
- **`FIND-SI4-ALERT-INSTRUMENTATION-25E596D712C8`** — severity `high` — POA&M: `POAM-AUTO-SI4-ALERT-INSTRUMENTATION-001`, `POAM-F20X-D-SI4-ALERT-INSTRUMENTATION-25E596D712C8`
  ...
  - Assessor workpaper: current `No enabled alert rule covers network.public_admin_port_opened.` → target `Evidence for SI-4, SI-4(1), SI-4(4), SI-4(16) is complete, system-generated where possible, linked to the affected asset/event/finding population, and retestable by an assessor sample.`; priority `critical`, effort `1-3 days`.
  - Remediation sample: Generate SPL/KQL/GCP/AWS query.; Add enabled alert.; Add recipient list.
- **`FIND-TRACKER-EVIDENCE-GAP-ANALYSIS-A3849B0D23AD`** — severity `critical` — POA&M: `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-A3849B0D23AD`
  ...
  - Assessor workpaper: current `gap-0001-inventory-mismatch [high/inventory_mismatch] row=1 controls=CM-8,CM-8(1),CM-8(3) poam_required=no :: Inventory mismatch: Provide the latest Integrated Inventory Workbook (IIW) plus` → target `Evidence is complete, linked to the assessed population, and retestable by an assessor sample.`; priority `moderate`, effort `1-3 days`.
  - Remediation sample: inventory (CM-8, CM-8(1), CM-8(3), CA-7): produce declared_inventory.csv reconciled against discovered_assets.json; close 2 gap(s); linked KSIs: KSI-INV-01.
- **`FIND-TRACKER-EVIDENCE-GAP-ANALYSIS-5D7AA2D77EAF`** — severity `critical` — POA&M: `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-5D7AA2D77EAF`
  ...
  - Assessor workpaper: current `gap-0002-inventory-mismatch [high/inventory_mismatch] row=2 controls=CM-8,CA-7 poam_required=no :: Inventory mismatch: Inventory of Load Balancers (ALB/NLB) and S3 buckets includi` → target `Evidence is complete, linked to the assessed population, and retestable by an assessor sample.`; priority `moderate`, effort `1-3 days`.
  - Remediation sample: inventory (CM-8, CM-8(1), CM-8(3), CA-7): produce declared_inventory.csv reconciled against discovered_assets.json; close 2 gap(s); linked KSIs: KSI-INV-01.
- **`FIND-TRACKER-EVIDENCE-GAP-ANALYSIS-2BB8C505F95D`** — severity `critical` — POA&M: `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-2BB8C505F95D`
  ...
  - Assessor workpaper: current `gap-0003-credentialed-scan-evidence-missing [high/credentialed_scan_evidence_missing] row=3 controls=RA-5,RA-5(3),RA-5(5) poam_required=yes :: Credentialed scan evidence missing: Provide the Nessus scan target list an...` → target `Evidence is complete, linked to the assessed population, and retestable by an assessor sample.`; priority `moderate`, effort `1-3 days`.
  - Remediation sample: inventory (CM-8, CM-8(1), CM-8(3), CA-7): produce declared_inventory.csv reconciled against discovered_assets.json; close 2 gap(s); linked KSIs: KSI-INV-01.
- **`FIND-TRACKER-EVIDENCE-GAP-ANALYSIS-A993E5B7AFB7`** — severity `critical` — POA&M: `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-A993E5B7AFB7`
  ...
  - Assessor workpaper: current `gap-0004-vulnerability-scan-evidence-missing [high/vulnerability_scan_evidence_missing] row=4 controls=RA-5,SI-2 poam_required=yes :: Vulnerability scan evidence missing: Latest Nessus vulnerability scan reports (f` → target `Evidence is complete, linked to the assessed population, and retestable by an assessor sample.`; priority `moderate`, effort `1-3 days`.
  - Remediation sample: inventory (CM-8, CM-8(1), CM-8(3), CA-7): produce declared_inventory.csv reconciled against discovered_assets.json; close 2 gap(s); linked KSIs: KSI-INV-01.
- **`FIND-TRACKER-EVIDENCE-GAP-ANALYSIS-9C44A567F119`** — severity `critical` — POA&M: `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-9C44A567F119`
  ...
  - Assessor workpaper: current `gap-0005-exploitation-review-missing [critical/exploitation_review_missing] row=5 controls=RA-5(8) poam_required=yes :: Exploitation review missing: Exploitation review for all High/Critical vulnerabi` → target `Evidence is complete, linked to the assessed population, and retestable by an assessor sample.`; priority `moderate`, effort `1-3 days`.
  - Remediation sample: inventory (CM-8, CM-8(1), CM-8(3), CA-7): produce declared_inventory.csv reconciled against discovered_assets.json; close 2 gap(s); linked KSIs: KSI-INV-01.
- **`FIND-TRACKER-EVIDENCE-GAP-ANALYSIS-3FA19ABD06CE`** — severity `critical` — POA&M: `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-3FA19ABD06CE`
  ...
  - Assessor workpaper: current `gap-0006-local-to-central-log-correlation-missing [high/local_to_central_log_correlation_missing] row=6 controls=AU-2,AU-3,AU-6,AU-12 poam_required=yes :: Local to central log correlation missing: Demonstrate centrali...` → target `Evidence is complete, linked to the assessed population, and retestable by an assessor sample.`; priority `moderate`, effort `1-3 days`.
  - Remediation sample: inventory (CM-8, CM-8(1), CM-8(3), CA-7): produce declared_inventory.csv reconciled against discovered_assets.json; close 2 gap(s); linked KSIs: KSI-INV-01.
- **`FIND-TRACKER-EVIDENCE-GAP-ANALYSIS-0E9FED1E409E`** — severity `critical` — POA&M: `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-0E9FED1E409E`
  ...
  - Assessor workpaper: current `gap-0007-alert-sample-missing [high/alert_sample_missing] row=7 controls=AU-6,SI-4 poam_required=yes :: Alert sample missing: Provide the alert rules / saved searches with recipient li` → target `Evidence is complete, linked to the assessed population, and retestable by an assessor sample.`; priority `moderate`, effort `1-3 days`.
  - Remediation sample: inventory (CM-8, CM-8(1), CM-8(3), CA-7): produce declared_inventory.csv reconciled against discovered_assets.json; close 2 gap(s); linked KSIs: KSI-INV-01.
- **`FIND-TRACKER-EVIDENCE-GAP-ANALYSIS-5DE8A547F602`** — severity `critical` — POA&M: `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-5DE8A547F602`
  ...
  - Assessor workpaper: current `gap-0008-response-action-missing [high/response_action_missing] row=8 controls=SI-4(1),SI-4(4) poam_required=yes :: Response action missing: List CloudWatch alarms and GuardDuty findings considere` → target `Evidence is complete, linked to the assessed population, and retestable by an assessor sample.`; priority `moderate`, effort `1-3 days`.
  - Remediation sample: inventory (CM-8, CM-8(1), CM-8(3), CA-7): produce declared_inventory.csv reconciled against discovered_assets.json; close 2 gap(s); linked KSIs: KSI-INV-01.
- **`FIND-TRACKER-EVIDENCE-GAP-ANALYSIS-0F9750A869F5`** — severity `critical` — POA&M: `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-0F9750A869F5`
  ...
  - Assessor workpaper: current `gap-0009-sia-missing [high/sia_missing] row=9 controls=CM-3,SI-2 poam_required=yes :: Sia missing: Sample change tickets in JIRA with full evidence chain: Security Im` → target `Evidence is complete, linked to the assessed population, and retestable by an assessor sample.`; priority `moderate`, effort `1-3 days`.
  - Remediation sample: inventory (CM-8, CM-8(1), CM-8(3), CA-7): produce declared_inventory.csv reconciled against discovered_assets.json; close 2 gap(s); linked KSIs: KSI-INV-01.
- **`FIND-TRACKER-EVIDENCE-GAP-ANALYSIS-B89FA44F2251`** — severity `critical` — POA&M: `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-B89FA44F2251`
  ...
  - Assessor workpaper: current `gap-0010-poam-update-missing [moderate/poam_update_missing] row=10 controls=CA-5 poam_required=yes :: Poam update missing: POA&M updates: Provide the current POA&M with deviation req` → target `Evidence is complete, linked to the assessed population, and retestable by an assessor sample.`; priority `moderate`, effort `1-3 days`.
  - Remediation sample: inventory (CM-8, CM-8(1), CM-8(3), CA-7): produce declared_inventory.csv reconciled against discovered_assets.json; close 2 gap(s); linked KSIs: KSI-INV-01.
- **`FIND-TRACKER-EVIDENCE-GAP-ANALYSIS-33EE70A2C5D0`** — severity `critical` — POA&M: `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-33EE70A2C5D0`
  ...
  - Assessor workpaper: current `gap-0011-response-action-missing [high/response_action_missing] row=11 controls=IR-4,IR-6 poam_required=yes :: Response action missing: Incident response evidence: any suspected or confirmed` → target `Evidence is complete, linked to the assessed population, and retestable by an assessor sample.`; priority `moderate`, effort `1-3 days`.
  - Remediation sample: inventory (CM-8, CM-8(1), CM-8(3), CA-7): produce declared_inventory.csv reconciled against discovered_assets.json; close 2 gap(s); linked KSIs: KSI-INV-01.
- **`FIND-TRACKER-EVIDENCE-GAP-ANALYSIS-4BAED87FEE15`** — severity `critical` — POA&M: `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-4BAED87FEE15`
  ...
  - Assessor workpaper: current `gap-0012-crypto-fips-evidence-missing [high/crypto_fips_evidence_missing] row=12 controls=SC-13,SC-28,SC-12 poam_required=no :: Crypto fips evidence missing: FIPS 140-2/3 evidence: list crypto modules in use` → target `Evidence is complete, linked to the assessed population, and retestable by an assessor sample.`; priority `moderate`, effort `1-3 days`.
  - Remediation sample: inventory (CM-8, CM-8(1), CM-8(3), CA-7): produce declared_inventory.csv reconciled against discovered_assets.json; close 2 gap(s); linked KSIs: KSI-INV-01.
- **`FIND-TRACKER-EVIDENCE-GAP-ANALYSIS-F27B227E58C1`** — severity `critical` — POA&M: `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-F27B227E58C1`
  ...
  - Assessor workpaper: current `gap-0013-restore-test-missing [high/restore_test_missing] row=13 controls=CP-9,CP-10 poam_required=yes :: Restore test missing: Backup and recovery evidence: most recent restore test (RT` → target `Evidence is complete, linked to the assessed population, and retestable by an assessor sample.`; priority `moderate`, effort `1-3 days`.
  - Remediation sample: inventory (CM-8, CM-8(1), CM-8(3), CA-7): produce declared_inventory.csv reconciled against discovered_assets.json; close 2 gap(s); linked KSIs: KSI-INV-01.
- **`FIND-TRACKER-EVIDENCE-GAP-ANALYSIS-135F006CD5F6`** — severity `critical` — POA&M: `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-135F006CD5F6`
  ...
  - Assessor workpaper: current `gap-0014-identity-listing-missing [high/identity_listing_missing] row=14 controls=AC-2,AC-2(7),AC-6 poam_required=no :: Identity listing missing: Account listings: full IAM user list with privileged-a` → target `Evidence is complete, linked to the assessed population, and retestable by an assessor sample.`; priority `moderate`, effort `1-3 days`.
  - Remediation sample: inventory (CM-8, CM-8(1), CM-8(3), CA-7): produce declared_inventory.csv reconciled against discovered_assets.json; close 2 gap(s); linked KSIs: KSI-INV-01.
- **`FIND-TRACKER-EVIDENCE-GAP-ANALYSIS-6B0E86FC0760`** — severity `critical` — POA&M: `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-6B0E86FC0760`
  ...
  - Assessor workpaper: current `gap-0015-traffic-flow-policy-missing [high/traffic_flow_policy_missing] row=15 controls=SC-7,SC-7(11) poam_required=no :: Traffic flow policy missing: Traffic flow / boundary evidence: data flow diagram` → target `Evidence is complete, linked to the assessed population, and retestable by an assessor sample.`; priority `moderate`, effort `1-3 days`.
  - Remediation sample: inventory (CM-8, CM-8(1), CM-8(3), CA-7): produce declared_inventory.csv reconciled against discovered_assets.json; close 2 gap(s); linked KSIs: KSI-INV-01.

### POA&M references (by KSI linkage)

POA&M ids tied to this KSI via `source_ksi_ids`: `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-0E9FED1E409E`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-0F9750A869F5`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-135F006CD5F6`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-2BB8C505F95D`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-33EE70A2C5D0`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-3FA19ABD06CE`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-4BAED87FEE15`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-5D7AA2D77EAF`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-5DE8A547F602`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-6B0E86FC0760`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-9C44A567F119`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-A3849B0D23AD`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-A993E5B7AFB7`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-B89FA44F2251`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-F27B227E58C1`, `POAM-F20X-D-SI4-ALERT-INSTRUMENTATION-25E596D712C8`, `POAM-F20X-D-SI4-ALERT-INSTRUMENTATION-3B5CDDC852D6`, `POAM-F20X-D-SI4-ALERT-INSTRUMENTATION-7712019CD417`
...
- **Evidence refs (structured):** `[{"evidence_id": "EV-1BC6343FE36EC1D07370", "role": "primary", "json_pointer": "#/evaluations", "artifact": "eval_results.json"}]`
- **Evidence posture (machine):** `missing_required_evidence=False`; `relies_on_manual_or_file_primary_evidence=False`; `automation_maturity_score=4`
...
- **Evidence refs (structured):** `[{"evidence_id": "EV-1BC6343FE36EC1D07370", "role": "primary", "json_pointer": "#/evaluations", "artifact": "eval_results.json"}]`
- **Evidence posture (machine):** `missing_required_evidence=False`; `relies_on_manual_or_file_primary_evidence=True`; `automation_maturity_score=2`
...
POA&M ids tied to this KSI via `source_ksi_ids`: `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-0E9FED1E409E`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-0F9750A869F5`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-135F006CD5F6`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-2BB8C505F95D`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-33EE70A2C5D0`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-3FA19ABD06CE`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-4BAED87FEE15`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-5D7AA2D77EAF`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-5DE8A547F602`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-6B0E86FC0760`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-9C44A567F119`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-A3849B0D23AD`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-A993E5B7AFB7`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-B89FA44F2251`, `POAM-F20X-ACKER-EVIDENCE-GAP-ANALYSIS-F27B227E58C1`
...
- **Evidence refs (structured):** `[{"evidence_id": "EV-1BC6343FE36EC1D07370", "role": "primary", "json_pointer": "#/evaluations", "artifact": "eval_results.json"}]`
- **Evidence posture (machine):** `missing_required_evidence=False`; `relies_on_manual_or_file_primary_evidence=True`; `automation_maturity_score=1`
